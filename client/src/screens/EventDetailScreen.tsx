...
type EventDetailScreenProps = StackScreenProps<ProfileStackParamList, 'EventDetail'>;

type EventDetailView = Partial<EventRecord> & {
  image?: string;
  place?: string;
  date?: string;
};

const EventDetailScreen = ({ route, navigation }: EventDetailScreenProps): React.JSX.Element => {
  const insets = useSafeAreaInsets();
  const event = (route.params?.event as EventDetailView | undefined) ?? undefined;
