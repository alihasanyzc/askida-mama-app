...
type EventsListScreenProps = StackScreenProps<ProfileStackParamList, 'EventsList'>;

type EventListItem = Partial<EventRecord> & {
  id: string;
  image: string;
  place: string;
  date: string;
...
const EventsListScreen = ({ navigation }: EventsListScreenProps): React.JSX.Element => {
